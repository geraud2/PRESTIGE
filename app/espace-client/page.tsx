...
export default function EspaceClientPage() {
  ...
  return (
    <>
      {/* Header */}
      <section className="bg-gradient-to-r from-black to-gray-800 text-white py-12 md:py-16 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-center md:text-right mt-4 md:mt-0">
              <div className="bg-[#CDA434] text-black px-3 py-1 md:px-4 md:py-2 rounded-lg font-medium mb-2 text-sm md:text-base">
                {userData.statut}
              </div>
              <Button 
                variant="outline" 
                className="text-white border-white hover:bg-white hover:text-black text-sm md:text-base"
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                <Card className="text-center p-4 md:p-6">
                  <FaCar className="text-2xl md:text-3xl text-[#CDA434] mx-auto mb-2 md:mb-4" />
                  <div className="text-xl md:text-2xl font-bold text-gray-900 mb-1 md:mb-2">12</div>
                  <div className="font-body text-sm md:text-base text-gray-600">Courses VTC</div>
                </Card>
                <Card className="text-center p-4 md:p-6">
                  <FaCar className="text-2xl md:text-3xl text-black mx-auto mb-2 md:mb-4" />
                  <div className="text-xl md:text-2xl font-bold text-gray-900 mb-1 md:mb-2">5</div>
                  <div className="font-body text-sm md:text-base text-gray-600">Locations</div>
                </Card>
                <Card className="text-center p-4 md:p-6">
                  <FaGraduationCap className="text-2xl md:text-3xl text-[#0057B7] mx-auto mb-2 md:mb-4" />
                  <div className="text-xl md:text-2xl font-bold text-gray-900 mb-1 md:mb-2">2</div>
                  <div className="font-body text-sm md:text-base text-gray-600">Formations</div>
                </Card>
                <Card className="text-center p-4 md:p-6">
                  <FaCertificate className="text-2xl md:text-3xl text-[#F7931E] mx-auto mb-2 md:mb-4" />
                  <div className="text-xl md:text-2xl font-bold text-gray-900 mb-1 md:mb-2">1</div>
                  <div className="font-body text-sm md:text-base text-gray-600">Certificat</div>
                </Card>
              </div>
                ...
                <Card className="p-4 md:p-6">
                  ...
                  <div className="space-y-3 md:space-y-4">
                    {reservations.slice(0, 3).map((reservation) => (
                      <div key={reservation.id} className="flex items-center justify-between p-3 md:p-4 bg-gray-50 rounded-lg">
                        <div>
                          <div className="font-medium text-sm md:text-base text-gray-900">{reservation.id}</div>
                          <div className="text-xs md:text-sm text-gray-600">{reservation.date}</div>
                        </div>
                        <div className="text-right">
                          <div className="font-bold text-base md:text-lg text-[#CDA434]">{reservation.prix}</div>
                    ...
                    {formations.map((formation) => (
                      <div key={formation.id}>
                        <div className="flex items-center justify-between mb-1 md:mb-2">
                          <div className="font-medium text-sm md:text-base text-gray-900">{formation.nom}</div>
                          <div className="text-xs md:text-sm text-gray-600">{formation.progression}%</div>
                        </div>
          ...
          {activeTab === 'reservations' && (
            <div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 md:mb-8">
                ...
                <Button variant="vtc" className="w-full sm:w-auto">
                  ...
                  <Card key={reservation.id} className="p-4 md:p-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div className="flex items-center space-x-4 md:space-x-6">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-[#CDA434] rounded-lg flex items-center justify-center flex-shrink-0">
                          <FaCar className="text-black text-sm md:text-base" />
                        </div>
                        <div>
                          <div className="font-heading font-bold text-base md:text-lg text-gray-900">
                            {reservation.id}
                          </div>
                      ...
                      <div className="text-left sm:text-right w-full sm:w-auto">
                        <div className="font-bold text-xl md:text-2xl text-[#CDA434] mb-2">
                          {reservation.prix}
                        </div>
          ...
          {activeTab === 'formations' && (
            <div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 md:mb-8">
                ...
                <Button variant="formations" className="w-full sm:w-auto">
                  Nouvelle formation
                </Button>
              </div>
                  ...
                  <Card key={formation.id} className="p-4 md:p-6">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-4 md:mb-6">
                      ...
                      <div className="text-left md:text-right">
                        <div className={`px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium mb-2 ${
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-body text-sm md:text-base text-gray-700">Progression</span>
                        <span className="font-body text-sm md:text-base text-gray-700">{formation.progression}%</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2 md:h-3">
                        <div 
                          className="bg-[#0057B7] h-2 md:h-3 rounded-full transition-all duration-300"
                          style={{ width: `${formation.progression}%` }}
                        ></div>
                      </div>
                    </div>
                    ...
                    {formation.statut === 'En cours' && (
                      <Button variant="formations" className="w-full md:w-auto">
              ...
              <div className="space-y-4">
                {factures.map((facture) => (
                  <Card key={facture.id} className="p-4 md:p-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div className="flex items-center space-x-4 md:space-x-6">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-[#0057B7] rounded-lg flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="text-left sm:text-right w-full sm:w-auto">
                        <div className="font-bold text-xl md:text-2xl text-gray-900 mb-2">
                          {facture.montant}
                        </div>
                        <div className="flex flex-wrap items-center gap-2">
                          <span className="bg-green-100 text-green-800 px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium">
                            {facture.statut}
                          </span>
                          <Button variant="outline" size="sm" className="text-xs md:text-sm">
                            <FaDownload className="mr-1 md:mr-2" />
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value={userData.nom}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#CDA434] focus:border-transparent text-sm md:text-base"
                        readOnly
                      />
                    </div>
                    <div>
                    ...
                    <Button variant="vtc" className="w-full md:w-auto">
                      Mettre à jour
                    </Button>
                  </div>
                </Card>
                ...
                <Card className="p-4 md:p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 md:p-4 bg-gray-50 rounded-lg">
                      <span className="font-body text-sm md:text-base text-gray-700">Statut</span>
                      <span className="bg-[#CDA434] text-black px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium">
                        {userData.statut}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-3 md:p-4 bg-gray-50 rounded-lg">
                      <span className="font-body text-sm md:text-base text-gray-700">Membre depuis</span>
                      <span className="font-body text-sm md:text-base text-gray-900">{userData.dateInscription}</span>
                    </div>
                    <div className="flex items-center justify-between p-3 md:p-4 bg-gray-50 rounded-lg">
                      <span className="font-body text-sm md:text-base text-gray-700">Dernière connexion</span>
                      <span className="font-body text-sm md:text-base text-gray-900">Aujourd'hui</span>
                    </div>
                  </div>

                  <div className="mt-6 md:mt-8">
                    <h4 className="font-heading text-base md:text-lg font-bold text-gray-900 mb-3 md:mb-4">
                      Sécurité
                    </h4>
