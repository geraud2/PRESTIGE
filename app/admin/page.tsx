...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Le reste de ton code (sidebar + contenu) reste identique */}
       ...
       <div className="flex">
        ...
        <main className="flex-1 p-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    {recentReservations.map((reservation) => (
                      <div key={reservation.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">{reservation.client}</p>
                          <p className="text-sm text-gray-600">{reservation.date} à {reservation.heure}</p>
                        </div>
                ...
                <Card>
                  ...
                  <div className="space-y-3">
                    <Button variant="vtc" className="w-full justify-start">
                      <FaPlus className="mr-2" />
                      Nouvelle réservation VTC
                    </Button>
                    <Button variant="formations" className="w-full justify-start">
                      <FaPlus className="mr-2" />
                      Créer une session de formation
                    </Button>
                    <Button variant="afrique" className="w-full justify-start">
                      <FaPlus className="mr-2" />
                      Publier un article
                    </Button>
                  </div>
          ...
          {activeTab === 'reservations' && (
            <div>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900">Réservations VTC</h2>
                <Button variant="vtc">
                  <FaPlus className="mr-2" />
                    ...
                    <tbody>
                      {recentReservations.map((reservation) => (
                        <tr key={reservation.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">{reservation.date} {reservation.heure}</td>
                          <td className="py-3 px-4">CDG → Paris Centre</td>
                          ...
                          <td className="py-3 px-4 font-bold text-[#CDA434]">{reservation.montant}</td>
                          <td className="py-3 px-4">
          ...
          {activeTab === 'vehicles' && (
            <div>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900">Planning des véhicules</h2>
                <Button variant="vtc">
                  <FaPlus className="mr-2" />
                  Ajouter véhicule
                </Button>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card>
                  <h3 className="text-lg font-bold text-gray-900 mb-4">BMW Série 3 - AB-123-CD</h3>
                ...
                <Card>
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Mercedes Classe E - EF-456-GH</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Statut:</span>
                ...
                <Card>
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Audi A6 - IJ-789-KL</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Statut:</span>
          ...
          {activeTab === 'formations' && (
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Gestion des formations</h2>
          ...
          {activeTab === 'seminaires' && (
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Gestion des séminaires</h2>
          ...
          {activeTab === 'blog' && (
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Gestion du blog</h2>
          ...
          {activeTab === 'crm' && (
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">CRM - Gestion clients</h2>
